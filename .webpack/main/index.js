...
var _a = __webpack_require__(/*! electron */ "electron"), app = _a.app, BrowserView = _a.BrowserView, BrowserWindow = _a.BrowserWindow, dialog = _a.dialog, Menu = _a.Menu, Tray = _a.Tray;
var fs = __webpack_require__(/*! fs */ "fs");
...
var createWindow = function () {
    ...
    mainWindow.loadURL('http://localhost:3000/main_window'); // refer to package.json line 46 for "magic", entry points are index.html and renderer.ts
    // Open the DevTools.
...
var openFile = function (file) {
    ...
    var returnObj = {}; // empty object to hold results
    returnObj[file] = []; // initializing the file path as a key, value empty obj
    var result = fs.readdirSync(file); //result is an array of arrays (which represent directorys) filled with file names
